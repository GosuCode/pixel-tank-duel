...
// Create a room up front (the caller connects to it right after).
...
module.exports = { sanitizeRoomCode, getRoom, createRoomWithVisibility, createSandboxRoom, listOpenRooms, totalPlayers, tickRooms };
